...
class App extends Component {
	...
	componentDidMount() {
		...
		if (!this.checkWebGLSupported()) {
			console.warn("WebGL not supported, but bypassing error page to test core functionality.");
	...
	render() {
		...
		let themeClass = (this.props.theme === 'dark') ? ' theme-dark' : '';
